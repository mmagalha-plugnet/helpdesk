...
then
	...
	rm -Rf ${FOLDER_WEB}${TAR_GLPI}/install/
	cp -Rf /tmp/pics/logo.png ${FOLDER_WEB}${FOLDER_GLPI}/pics/login_logo_glpi.png
	cp -Rf /tmp/pics/logo.png ${FOLDER_WEB}${FOLDER_GLPI}/pics/fd_logo.png
	cp -Rf /tmp/css/* ${FOLDER_WEB}${FOLDER_GLPI}/css/.
	cp -Rf /tmp/conf/* ${FOLDER_WEB}${FOLDER_GLPI}/config/.
